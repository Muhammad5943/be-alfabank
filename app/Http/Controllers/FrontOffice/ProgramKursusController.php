...
class ProgramKursusController extends Controller
{
    ...
    public function index()
    {
        ...
        try {
            ...
            $programkursus->nama = $request->program_kursus;
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $programkursus->nama = $request->program_kursus ? $request->program_kursus : $programkursus->nama;
            ...
            $response = $programkursus::with('kompetensis','programkursusinstrukturs.instrukturs')->where(['id'=>$programkursus->id])->get();
